...
AFLAGS = -DNDEBUG
AINC = -I includeCC65
OBJS = wotahero.o muzak.o unpucrunch.o startup.o imagemoiety.o spritemoiety.o imageRAMmoiety.o tools.o bss.o ciatimer.o irqmoiety.o scrollermoiety.o image_clear_even_odd.o globalzeropage.o whiteout_spiral.o trigonometric.o
